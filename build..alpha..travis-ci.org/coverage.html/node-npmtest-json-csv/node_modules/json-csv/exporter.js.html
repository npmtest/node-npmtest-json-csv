...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-json-csv/node_modules/json-csv/exporter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-json-csv">npmtest-json-csv (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-json-csv/node_modules/json-csv/exporter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90.41% <small>(66 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">79.55% <small>(35 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-json-csv/node_modules/json-csv/</a> &#187; exporter.js</div>
</div>
<div class="body">
...
exporter.prototype.csvBuffered = function(data, options, done) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!data) <span class="cstat-no" title="statement not covered" >throw new Error("No data provided.")</span>
&nbsp;
...
exporter.prototype.getHeaderRow = function() {
  ...
  var header = _.reduce(self.options.fields, function(line, field) {
    var label = field.label || <span class="branch-1 cbranch-no" title="branch not covered" >field.name</span>
    if (line === 'START') {
      line = '';
    } else {
...
exporter.prototype.getBodyRow = function(data) {
  ...
  var row = _.reduce(this.options.fields, function(line, field) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof val !== 'undefined' &amp;&amp; val !== null) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (args[0] === "this")
<span class="cstat-no" title="statement not covered" >    return data</span>
&nbsp;
  var val = data[args[ix]]
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof val === 'undefined')
<span class="cstat-no" title="statement not covered" >    return ''</span>
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 13:24:13 GMT+0000 (UTC)</div>
</div>
</body>
</html>
